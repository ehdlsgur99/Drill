...
# Boy Event
RIGHT_DOWN, LEFT_DOWN, RIGHT_UP, LEFT_UP,  DASH_DOWN,  SLEEP_TIMER, DASH_TIMER = range(7)
...
class SleepState:
    ...
    def draw(boy):
        if boy.dir == 1:
            ...
            boy.image.clip_composite_draw(boy.frame * 100, 200, 100, 100, -3.141592 / 2, '', boy.x + 25,
                                          boy.y - 25, 100, 100)
...
next_state_table = {
    ...
    SleepState : {LEFT_DOWN : RunState, RIGHT_DOWN : RunState,
                  ...
                  DASH_DOWN : SleepState
                  },
    DashState : {DASH_TIMER : RunState, LEFT_UP : IdleState,
                 RIGHT_UP : IdleState}
}
